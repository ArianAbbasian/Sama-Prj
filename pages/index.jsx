  ...
  const features = [
    {
      ...
      description:
        "سیستم جامع مدیریت اطلاعات بیماران با قابلیت جستجو و فیلتر پیشرفته",
    },
    {
        ...
        >
          <Box sx={{ width: "100%" }}>
            ...
            >
              ...
              <Grid item xs={12} md={6}>
                ...
                >
                  ...
                  >
                    برای دسترسی به سیستم مدیریت، روی دکمه زیر کلیک کنید تا توکن
                    دسترسی دریافت شود.
                  </Typography>
                  ...
                  <Button
                    ...
                    sx={{
                      ...
                      "&:hover": {
                        ...
                        boxShadow: loading ? 6 : 8,
                      },
                      transition: "all 0.3s ease",
                    }}
                  >
                    {loading ? "در حال دریافت توکن..." : " ورود به پنل مدیریت "}
                  </Button>
            ...
            >
              <Typography
                variant="body2"
                sx={{ opacity: 0.8, fontSize: { xs: "0.7rem", md: "0.8rem" } }}
              >
                برای تست سیستم، روی دکمه "شروع کنید" کلیک کنید تا توکن دسترسی
                دریافت شود
              </Typography>
            </Paper>
          </Box>
